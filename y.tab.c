...
#line 469 "parser.y"
                                                       {add_variable(var_list,(yyvsp[-1].value),(yyvsp[-3].nPtr));(yyval.nPtr) = mkNode((yyvsp[-3].nPtr),1,(yyvsp[-1].value));}
#line 2882 "y.tab.c"
    break;

  case 177: /* variable_declaration: VAR type ':' identifiers ';'  */
#line 470 "parser.y"
                                                                                        {add_variable(var_list,(yyvsp[-1].nPtr),(yyvsp[-3].nPtr));(yyval.nPtr) = mkNode((yyvsp[-3].nPtr),1,(yyvsp[-1].nPtr));}
#line 2888 "y.tab.c"
    break;
